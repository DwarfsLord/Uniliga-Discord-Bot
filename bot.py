...
def draw_team_name(image, string, font_name, area_center_x, area_center_y, max_x, colour):
    ...
    image.multiline_text((area_center_x-x/2,area_center_y-y/2), string, colour, font = font, align = "center")
...
def draw_score(image, score_left, score_right, font_size = 45):
    ...
    image.multiline_text((235-x,140), str(score_left), (255,255,255), font = score_font, align = "right")
    image.multiline_text((265,140), str(score_right), (255,255,255), font = score_font, align = "left")
